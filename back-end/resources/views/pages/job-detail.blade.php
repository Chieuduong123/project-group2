                ...
                <div class="job_details_header">
                    <div class="single_jobs white-bg d-flex justify-content-between">
                        <div class="jobs_left d-flex align-items-center">
                            ...
                            <div class="jobs_conetent">
                                ...
                                <div class="links_locat d-flex align-items-center">
                                    <div class="location">
                                        <p> <img src="images/maps-and-flags.png" alt=""> California, USA</p>
                                    </div>
                                    <div class="location">
                                        <p> <img src="images/time.png" alt=""> Part-time</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="jobs_right">
                            <div class="apply_now">
                                <a class="heart_mark" href="#"> <img src="images/love.png" alt=""> </a>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="col-md-12">
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <button type="button" id="inputGroupFileAddon03"><img src="images/upload.png"
                                                alt="">
                                        </button>
                                    </div>
